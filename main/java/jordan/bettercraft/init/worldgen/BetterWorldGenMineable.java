...
public class BetterWorldGenMineable extends WorldGenerator
{
    ...
    public BetterWorldGenMineable(IBlockState state, int blockCount)
    {
        this(state, blockCount, BlockMatcher.forBlock(Blocks.STONE));
    }

    public BetterWorldGenMineable(IBlockState state, int blockCount, Predicate<IBlockState> p_i45631_3_)
    {
        this.oreBlock = state;
