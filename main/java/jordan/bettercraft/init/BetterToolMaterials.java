...
public class BetterToolMaterials 
{
	...
	public static ToolMaterial EMERALD = EnumHelper.addToolMaterial("EMERALD", 2, 800, 13.0F, 3.5F, 8);
	public static ToolMaterial COPPER = EnumHelper.addToolMaterial("COPPER", 2, 300, 6.0F, 2000.0F, 10);
}
