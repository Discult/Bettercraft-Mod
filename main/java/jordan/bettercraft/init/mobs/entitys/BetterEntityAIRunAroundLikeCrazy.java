...
public class BetterEntityAIRunAroundLikeCrazy extends EntityAIBase
{
	 private EntityZebra horseHost;
	    private double speed;
	    private double targetX;
	    private double targetY;
	    private double targetZ;

	    public BetterEntityAIRunAroundLikeCrazy(EntityZebra horse, double speedIn)
	    {
