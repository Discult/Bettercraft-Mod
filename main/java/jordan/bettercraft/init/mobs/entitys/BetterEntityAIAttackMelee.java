...
public class BetterEntityAIAttackMelee extends EntityAIBase
{
    World worldObj;
    ...
    public BetterEntityAIAttackMelee(EntityCreature creature, double speedIn, boolean useLongMemory)
    {
