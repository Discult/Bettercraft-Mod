...
public class EntityZebra extends EntityAnimal implements IInventoryChangedListener, IJumpingMount
{
    private static final Predicate<Entity> IS_HORSE_BREEDING = new Predicate<Entity>()
    {
        public boolean apply(@Nullable Entity p_apply_1_)
        {
            return p_apply_1_ instanceof EntityZebra && ((EntityZebra)p_apply_1_).isBreeding();
        }
    };
    ...
    private static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityZebra.class, DataSerializers.BYTE);
    private static final DataParameter<Integer> HORSE_TYPE = EntityDataManager.<Integer>createKey(EntityZebra.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> HORSE_VARIANT = EntityDataManager.<Integer>createKey(EntityZebra.class, DataSerializers.VARINT);
    ...
    private static final DataParameter<Integer> HORSE_ARMOR = EntityDataManager.<Integer>createKey(EntityZebra.class, DataSerializers.VARINT);
    ...
    protected void initEntityAI()
    {
        ...
        this.tasks.addTask(1, new BetterEntityAIRunAroundLikeCrazy(this, 1.2D));
    ...
    protected EntityZebra getClosestHorse(Entity entityIn, double distance)
    {
    ...
    public void openGUI(BetterEntityPlayer playerEntity)
    {
    ...
    public boolean processInteract(BetterEntityPlayer player, EnumHand hand, @Nullable ItemStack stack)
    {
    ...
    public void onLivingUpdate()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                EntityZebra entityhorse = this.getClosestHorse(this, 16.0D);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal)
    {
        ...
        {
            EntityZebra entityhorse = (EntityZebra)otherAnimal;
    ...
    {
        EntityZebra entityhorse = (EntityZebra)ageable;
        EntityZebra entityhorse1 = new EntityZebra(this.worldObj);
        HorseType horsetype = this.getType();
        HorseType horsetype1 = entityhorse.getType();
    ...
    public IEntityLivingData onInitialSpawn(DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata)
    {
        ...
        if (livingdata instanceof EntityZebra.GroupData)
        {
            horsetype = ((EntityZebra.GroupData)livingdata).horseType;
            i = ((EntityZebra.GroupData)livingdata).horseVariant & 255 | this.rand.nextInt(5) << 8;
        }
        else
        {
            ...
            livingdata = new EntityZebra.GroupData(horsetype, i);
        }
    ...
    public class BetterEntityPlayer extends EntityPlayer
    {

		public BetterEntityPlayer(World worldIn, GameProfile gameProfileIn) 
		{
		...
		public void openGuiHorseInventory(EntityZebra horse, IInventory inventoryIn)
	    {
