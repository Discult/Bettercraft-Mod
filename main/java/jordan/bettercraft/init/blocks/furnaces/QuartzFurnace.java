...
public class QuartzFurnace extends BlockContainer 
{
    ...
    {
        return Item.getItemFromBlock(BetterBlocks.QUARTZ_FURNACE);
    }
    ...
    public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        {
            worldIn.setBlockState(pos, BetterBlocks.QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BetterBlocks.QUARTZ_FURNACE.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
    ...
    {
        return new ItemStack(BetterBlocks.QUARTZ_FURNACE);
    }
